...
import 'package:chat_server/src/generated/media/media_finalize_result.dart'
    as _i8;
import 'package:chat_server/src/generated/messaging/chat_thread.dart' as _i9;
import 'package:chat_server/src/generated/safety/safety_report.dart' as _i10;
import 'package:chat_server/src/stories/story_model.dart' as _i11;
import 'package:chat_server/src/generated/streaming/chat_stream_envelope.dart'
    as _i12;
import 'package:chat_server/src/generated/messaging/message_sync_page.dart'
    as _i13;
...
class _DeviceEndpoint {
  ...
  _i3.Future<List<String>> list(_i1.TestSessionBuilder sessionBuilder) async {
...
class _CallEndpoint {
  ...
  _i3.Future<String> initiateCall(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    String deviceId,
  ...
  _i3.Future<void> sendIceCandidate(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    String deviceId,
    String callId,
...
class _MediaEndpoint {
  ...
  _i3.Future<_i6.MediaUploadSlot> requestUpload(
    _i1.TestSessionBuilder sessionBuilder,
...
class _ChatEndpoint {
  ...
  _i3.Future<_i9.ChatThread> openDirectChat(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<_i9.ChatThread> createGroupChat(
    _i1.TestSessionBuilder sessionBuilder,
    String? title,
  ...
  _i3.Future<_i9.ChatThread> getChatDetails(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<void> addGroupMembers(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue chatId,
    List<String> memberAuthUserIds,
  ) async {
  ...
  _i3.Future<void> removeGroupMember(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue chatId,
  ...
  _i3.Future<List<_i9.ChatThread>> listMyChats(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i9.ChatThread>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _SafetyEndpoint {
  ...
  _i3.Future<_i10.SafetyReport> submitReport(
    _i1.TestSessionBuilder sessionBuilder, {
    String? targetUserId,
    String? targetChatId,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i10.SafetyReport>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _KeyEndpoint {
  ...
  _i3.Future<String?> fetchUserBundle(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'key',
            method: 'fetchUserBundle',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'key',
          methodName: 'fetchUserBundle',
  ...
  _i3.Future<void> uploadWrappedKeys(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'key',
            method: 'uploadWrappedKeys',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'key',
          methodName: 'uploadWrappedKeys',
          parameters: _i1.testObjectToJson({
            'chatId': chatId,
...
class _StoryEndpoint {
  ...
  _i3.Future<_i11.Story> createStory(
    _i1.TestSessionBuilder sessionBuilder, {
  ...
  _i3.Future<List<_i11.Story>> listStories(
    _i1.TestSessionBuilder sessionBuilder, {
  ...
  _i3.Future<List<String>> getViewers(
    _i1.TestSessionBuilder sessionBuilder, {
    required String storyId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<int> cleanupExpired(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'story',
...
class _ChatStreamEndpoint {
  ...
  _i3.Stream<_i12.ChatStreamEnvelope> chatRoom(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    String deviceId,
    _i3.Stream<_i12.ChatStreamEnvelope> inbound,
  ) {
    var _localTestStreamManager =
        _i1.TestStreamManager<_i12.ChatStreamEnvelope>();
...
class _SyncEndpoint {
  ...
  _i3.Future<_i13.MessageSyncPage> getChanges(
    _i1.TestSessionBuilder sessionBuilder,
    String? cursor,
    int limit,
  ) async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i13.MessageSyncPage>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i13.MessageSyncPage> getChatChanges(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    String? cursor,
    int limit,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'getChatChanges',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'getChatChanges',
          parameters: _i1.testObjectToJson({
            'chatId': chatId,
            'cursor': cursor,
            'limit': limit,
