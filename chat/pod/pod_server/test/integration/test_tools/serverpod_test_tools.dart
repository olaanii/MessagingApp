...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:pod_server/src/generated/greetings/greeting.dart' as _i5;
import 'package:pod_server/src/generated/messaging/chat_thread.dart' as _i6;
import 'package:pod_server/src/generated/messaging/registered_device.dart'
    as _i7;
import 'package:pod_server/src/generated/messaging/chat_message.dart' as _i8;
import 'package:pod_server/src/generated/messaging/message_sync_page.dart'
    as _i9;
import 'package:pod_server/src/generated/protocol.dart';
import 'package:pod_server/src/generated/endpoints.dart';
...
class _ChatEndpoint {
  ...
  _i3.Future<_i6.ChatThread> openDirectChat(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<List<_i6.ChatThread>> listMyChats(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.ChatThread>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _DeviceEndpoint {
  ...
  _i3.Future<_i7.RegisteredDevice> registerDevice(
    _i1.TestSessionBuilder sessionBuilder,
    String deviceId,
    String platform,
    String? name,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i7.RegisteredDevice>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _MessageEndpoint {
  ...
  _i3.Future<_i8.ChatMessage> sendMessage(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue chatId,
    String deviceId,
    String clientMsgId,
  ...
  _i3.Future<_i9.MessageSyncPage> syncMessages(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue chatId,
    String? cursor,
    int limit,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i9.MessageSyncPage>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
