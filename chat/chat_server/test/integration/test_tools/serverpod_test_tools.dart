...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:chat_server/src/generated/greetings/greeting.dart' as _i5;
import 'package:chat_server/src/generated/media/media_upload_slot.dart' as _i6;
import 'package:chat_server/src/generated/media/media_upload_request.dart'
    as _i7;
import 'package:chat_server/src/generated/media/media_finalize_result.dart'
    as _i8;
import 'package:chat_server/src/generated/safety/safety_report.dart' as _i9;
...
import 'package:chat_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _ThrottledEmailIdpEndpoint throttledEmailIdp;

  late final _GreetingEndpoint greeting;

  late final _MediaEndpoint media;

  late final _SafetyEndpoint safety;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    throttledEmailIdp = _ThrottledEmailIdpEndpoint(
      endpoints,
      serializationManager,
    );
...
class _ThrottledEmailIdpEndpoint {
  _ThrottledEmailIdpEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i4.AuthSuccess> login(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'throttledEmailIdp',
            method: 'login',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'throttledEmailIdp',
          methodName: 'login',
          parameters: _i1.testObjectToJson({
            'email': email,
            'password': password,
...
class _MediaEndpoint {
  ...
  _i3.Future<_i6.MediaUploadSlot> requestUploadSlot(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'media',
            method: 'requestUploadSlot',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'media',
          methodName: 'requestUploadSlot',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.MediaUploadSlot>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i8.MediaFinalizeResult> finalizeUpload(
    _i1.TestSessionBuilder sessionBuilder,
    String mediaId,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.MediaFinalizeResult>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _SafetyEndpoint {
  ...
  _i3.Future<_i9.SafetyReport> submitReport(
    _i1.TestSessionBuilder sessionBuilder, {
    String? targetUserId,
    String? targetChatId,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i9.SafetyReport>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _ChatStreamEndpoint {
  ...
  _i3.Stream<_i10.ChatStreamEnvelope> chatRoom(
    _i1.TestSessionBuilder sessionBuilder,
    String chatId,
    String deviceId,
    _i3.Stream<_i10.ChatStreamEnvelope> inbound,
  ) {
    var _localTestStreamManager =
        _i1.TestStreamManager<_i10.ChatStreamEnvelope>();
